        ...
        <div className='info w-full xl:w-1/2 pl-4 flex flex-col'>
          ...
          <div className='waterfor pl-3 flex flex-col justify-around'>
            ...
            <div className='sagslah'>
                ...
                <form action="" id="mlform" className='flex relative flex-col md:flex-row text-center'>
                  ...
                  <div className='tablenames absolute flex flex-col md:flex-row text-sm 9xl:text-3xl mt-1'>
                    ...
                    <div className='tablename3'>
                      <p className='mt-10 md:mt-0'>Нийт үнэ</p>
                    </div>
                  </div>
             ...
             {array == '' ? '' 
             : <Link to="/order"> <h4 className='flex justify-center text-gray-400 xl:hidden mt-3 hover:text-black'> 
                <img src={sagsicon} alt="" className='w-[8%] sm:w-[6%] md:w-[5%]'/>  
                <img src={rightArrow} alt="" className='ml-5 w-[6%] sm:w-[5%] md:w-[3%] hover:w-[3.2%]'/> </h4> 
             </Link>}
